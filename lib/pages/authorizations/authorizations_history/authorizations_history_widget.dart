...
class _AuthorizationsHistoryWidgetState
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {});
      _model.allAuthsResp = await GetAllAuthorizationsCall.call(
      ...
      if ((_model.allAuthsResp?.succeeded ?? true)) {
        FFAppState().allAuthorizations = GetAllAuthorizationsCall.rows(
          (_model.allAuthsResp?.jsonBody ?? ''),
            ...
            .cast<dynamic>();
        setState(() {});
        _model.authorizationsTotal = GetAllAuthorizationsCall.totalRows(
          (_model.allAuthsResp?.jsonBody ?? ''),
        );
        setState(() {});
      } else {
                      ...
                      onTap: () async {
                        ...
                        if ((_model.searchAuthsResp?.succeeded ?? true)) {
                          ...
                          _model.authorizationsTotal =
                              GetAllAuthorizationsCall.totalRows(
                            (_model.searchAuthsResp?.jsonBody ?? ''),
                          );
                          setState(() {});
                        } else {
