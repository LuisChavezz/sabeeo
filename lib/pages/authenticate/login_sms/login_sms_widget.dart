...
class LoginSmsWidget extends StatefulWidget {
  const LoginSmsWidget({super.key});
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Text(
                                        'Introduce el número de teléfono asociado a tu cuenta y te enviaremos un código SMS para iniciar sesión.',
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        _model.loginOtpResp =
                                            await AuthenticateGroup.loginOTPCall
                                                .call(
                                          phone: _model
                                        ...
                                        shouldSetState = true;
                                        if ((_model.loginOtpResp?.succeeded ??
                                            true)) {
