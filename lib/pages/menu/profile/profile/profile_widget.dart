...
class _ProfileWidgetState extends State<ProfileWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.profileResp?.succeeded ?? true)) {
              ...
              return WebViewAware(
                child: Padding(
                  ...
                  child: AlertMessageWidget(
                    buttonText: 'Aceptar',
                    title:
                        'Error: ${(_model.profileResp?.statusCode ?? 200).toString()}',
                    message: UsersGroup.profileCall.message(
                      (_model.profileResp?.jsonBody ?? ''),
                    )!,
                  ),
                ),
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                Expanded(
                                                  child: Text(
                                                    '${UsersGroup.profileCall.firstname(
                                                      (_model.profileResp
                                                              ?.jsonBody ??
                                                          ''),
                                                    )} ${UsersGroup.profileCall.lastname(
                                                      (_model.profileResp
                                                              ?.jsonBody ??
                                                          ''),
                                                    )}',
