...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    sabeeoAuthUserSubject.add(
      SabeeoAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SabeeoAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SabeeoAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SabeeoAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    sabeeoAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
