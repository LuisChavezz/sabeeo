...
class AppStateNotifier extends ChangeNotifier {
  ...
  void update(SabeeoAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Login_sms',
          path: '/loginSms',
          builder: (context, params) => const LoginSmsWidget(),
        ),
        FFRoute(
          name: 'Login_otp',
          path: '/loginOtp',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/splash_sabeeo.gif',
                    fit: BoxFit.fitWidth,
                  ),
                )
              : page;
